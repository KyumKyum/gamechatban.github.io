...
![image_argue](/assets/images/argue.png){: width="50%", .align-center}
...
그렇다면 이러한 게임 속 대화의 문제점을 제재하기 위한 방안은 어떤 것이 있었을까. 먼저 유명 게임 리그오브레전드(League of Legends)에서는 "지속적으로 부정적인 행동을 보이는 계정이 가장 먼저 받는 불이익은 주로 채팅 제한입니다. 해당 기능이 활성화되면 게임 내에서 채팅을 할 수 없습니다. 채팅 제한은 특정 일수가 지날 때까지 지속됩니다."[^2]라는 규정을 가지고 있다. 이외에도 다양한 게임에서 부적절한 채팅을 주고받을 때 처벌을 가하는 조항을 가지고 있다.
